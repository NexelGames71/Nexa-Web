...
export const PRICING_PLANS = [
  {
    ...
    price: "Free",
    period: "",
    description: "Try Nexa Chat with core models and limited memory.",
    features: ["Nexa Fast model", "Basic memory", "Web search (limited)", "Community support"],
  ...
  },
  {
    ...
    price: "$20",
    period: "/ month",
    description: "For power users who need Think models and more memory.",
    features: ["Nexa Think", "Expanded memory", "Voice preview", "Priority support"],
    cta: { href: "/signup", label: "Upgrade to Pro" },
    highlighted: true,
  },
  {
    id: "premium",
    ...
    price: "$40",
    period: "/ month",
    description: "Deep Think, agents, and higher rate limits.",
    features: ["Nexa Deep Think", "Custom assistants", "Advanced search", "Export tools"],
    cta: { href: "/signup", label: "Go Premium" },
    highlighted: false,
  },
  {
    id: "business",
    ...
    price: "$99",
    period: "/ seat / month",
    description: "Team workspace, admin controls, and shared billing.",
    features: ["Team management", "Shared memory policies", "Admin dashboard", "SSO (soon)"],
